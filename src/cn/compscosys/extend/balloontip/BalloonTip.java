...
public class BalloonTip extends JPanel { 
    ...
    private final Icon defaultIcon  = new ImageIcon(BalloonTip.class.getResource("/cn/compscosys/images/balloon/closebutton_default.png"));   
    private final Icon rolloverIcon = new ImageIcon(BalloonTip.class.getResource("/cn/compscosys/images/balloon/closebutton_rollover.png"));   
    private final Icon pressedIcon  = new ImageIcon(BalloonTip.class.getResource("/cn/compscosys/images/balloon/closebutton_pressed.png"));   
